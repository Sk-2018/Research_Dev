# -*- coding: utf-8 -*-
"""
PerfectUnifiedPayloadDiff_GeminiUltra_Pro_FIXED.py
"""
...
class GeminiUltraPro(tk.Tk):
    ...
    def identify_columns(self):
        """FIXED: Handle None column names."""
        if self.df is None or self.df.empty:
            messagebox.showerror("Error", "No data loaded")
            return
        
        # FIX: Convert None to empty string
    ...
    def on_select_config(self, event):
        ...
        rows = self.df[self.df[self.config_col].astype(str) == cfg]

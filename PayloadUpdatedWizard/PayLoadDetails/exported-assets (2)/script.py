...
# Create a simplified version that just launches PayloadDiffViewer with CSV/XLSX files
simple_launcher = '''# -*- coding: utf-8 -*-
"""
...
# Write the simple launcher
with open('SimplePayloadLauncher.py', 'w', encoding='utf-8') as f:
...
print("Size:", len(simple_launcher), "characters")
print("\nFeatures:")

...
# Create an enhanced version with separate Config Name dropdown and Config Key list
# This provides a two-stage selection: First select Config Name, then select Config Key
...
with open("PerfectUnifiedPayloadDiff_GeminiUltra_Pro_ENHANCED_V2.py", "w", encoding="utf-8") as f:
    f.write(enhanced_code)

print("✅ ENHANCED V2 CODE SAVED!")
print("\nFile: PerfectUnifiedPayloadDiff_GeminiUltra_Pro_ENHANCED_V2.py")
print("\n" + "="*80)
print("NEW FEATURES - TWO-STAGE SELECTION:")
print("="*80)
print("1. ✅ Config Name Dropdown: Select config type (e.g., 'acq_profl')")
print("2. ✅ Config Keys List: Shows all related keys for selected config name")
print("3. ✅ Smart Filtering: Only alphanumeric + underscore config names")
print("4. ✅ Search Box: Filter config keys in real-time")
print("5. ✅ Key Counter: Shows filtered/total key count")
print("6. ✅ Clean Layout: Left pane for keys, right pane for diffs")
print("\n" + "="*80)
print("WORKFLOW:")
print("="*80)
print("Step 1: Select Config Name (e.g., 'acq_profl')")
print("Step 2: See all related Config Keys (33265, 18798, etc.)")
print("Step 3: Search/filter keys if needed")
print("Step 4: Click a key to view its diff")
print("\n✨ Much cleaner and faster navigation!")

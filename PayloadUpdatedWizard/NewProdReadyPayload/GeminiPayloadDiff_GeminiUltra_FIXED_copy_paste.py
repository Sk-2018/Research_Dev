...
class PayloadDiffViewerApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        # Enable copy/paste helpers for the main panes
        self._setup_tree_copy_paste()
        self._make_text_copy_paste(self.txt_sel_old)
        self._make_text_copy_paste(self.txt_sel_new)
        self._make_text_copy_paste(self.txt_old)
        self._make_text_copy_paste(self.txt_cur)


    def _make_text_copy_paste(self, widget: tk.Text):
        """
        Enable standard copy/paste/select-all shortcuts and right-click menu
        for a Text widget so users can easily copy and paste content.
        """
    ...
    def _setup_tree_copy_paste(self):
        """
        Add a simple 'Copy row' capability to the main Treeview so that
        the selected row can be copied and pasted elsewhere.
        """
        tree = self.tree

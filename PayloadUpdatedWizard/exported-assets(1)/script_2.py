...
# Create the ultra-optimized viewer integrated with fast loader
viewer_ultra = '''# -*- coding: utf-8 -*-
"""
...
with open('PayloadDiffViewer_ULTRA.py', 'w', encoding='utf-8') as f:
    f.write(viewer_ultra)

print("✅ Created: PayloadDiffViewer_ULTRA.py")
print("="*80)
